...
(define g4 (game-player-set-move g3 p2 1))  ; Mauricio coloca en columna 2
(define g5 (game-player-set-move g4 p1 2))  ; Juan coloca en columna 2
(define g6 (game-player-set-move g5 p2 2))  ; Mauricio coloca en columna 3
(define g7 (game-player-set-move g6 p1 3))  ; Juan coloca en columna 2
